...
# print(10,data_value_train, data_value_train[0], len(data_value_train[0]))
print(10, data_value_train, len(data_value_train), len(data_value_train[0]))
print(11, data_time_train, len(data_time_train))
print(12, stations_sorted, len(stations_sorted))

# data_list = data_value_train.reshape(-1,2)
# data_list = data_list.squeeze()
# data_list = data_list.reshape(20000,1024)
# df = pd.DataFrame(data_value_train)
